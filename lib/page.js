...
const Page = ({ page }) => {
  ...
  return (
    <PageLayout>
      ...
      {fullPage.templates && fullPage.templates.length === 0 && (<h1>Hello</h1>)}
      {/* {fullPage.templates  && fullPage.templates.length && fullPage.templates.map((section, i) => {
        return <div><h1>hi</h1><h1>hi</h1><h1>hi</h1><h1>hi</h1><h1>hi</h1><h1>hi</h1><h1>hi</h1><h1>hi</h1><h1>hi</h1></div>
