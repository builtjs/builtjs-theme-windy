...
export const transformPage = async (pageDoc) => {
  return new Promise(async (resolve) => {
    ...
    let fullPage = {};
    if(pageDoc.layout && pageDoc.layout.headerSection){
      fullPage.header = await getTemplate(pageDoc.layout.headerSection.slug, pageDoc);
    }
    let templates = [];
    ...
    if(pageDoc.layout && pageDoc.layout.footerSection){
      fullPage.footer = await getTemplate(pageDoc.layout.footerSection.slug, pageDoc);
    }
    resolve(fullPage);
  });
};
