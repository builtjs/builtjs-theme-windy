      ...
      <section className="px-5 pt-12 pb-8 bg-gray-800">
        <ul className="flex flex-wrap items-center justify-center mb-10">
          {navlinks.map(({ href, label }) => (
            <li key={`${href}${label}`}>
              <a
                href={href}
                className="flex px-3 py-2 text-gray-400 transition duration-200 ease-in-out hover:text-white"
              >
                {label}
              </a>
            </li>
        ...
        <div className="flex justify-center mb-12">
          <Link href="/">
            <a>
              <svg
                className="w-5 mr-6 text-gray-500 hover:text-gray-400"
        ...
        <div className="flex justify-center">
          <p className="text-xs tracking-wide text-center text-white">
